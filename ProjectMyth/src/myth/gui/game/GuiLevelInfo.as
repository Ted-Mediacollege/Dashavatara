package myth.gui.game 
{
	...
	public class GuiLevelInfo extends GuiScreen
	{
		...
		{ 
			...
			var b2:GuiButton = addButton(new GuiButton(1, TextureList.atlas_gui.getTexture("button_small"), screenWidth / 2, screenHeight / 2 + 330, 450, 100, "Back To Level Select", 25, 0x000000));
		}
