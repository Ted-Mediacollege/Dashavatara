package myth.gui.game 
{
	...
	public class GuiLevelInfo extends GuiScreen
	{
		...
		{ 
			...
			{
				case 0: var m1:Image = new Image(AssetList.assets.getTexture("map_1")); addChild(m1); break;
				case 1: var m2:Image = new Image(AssetList.assets.getTexture("map_2")); addChild(m2); break;
				case 2: var m3:Image = new Image(AssetList.assets.getTexture("map_31")); addChild(m3); var m4:Image = new Image(AssetList.assets.getTexture("map_32")); m4.x = 640; m4.blendMode = BlendMode.NONE; addChild(m4); break;
			}
